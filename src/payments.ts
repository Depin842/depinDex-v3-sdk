...
import IPeripheryPaymentsWithFee from 'depin-dex-v3-periphery/artifacts/contracts/interfaces/IPeripheryPaymentsWithFee.sol/IPeripheryPaymentsWithFee.json'
