...
import { BigintIsh, Currency, CurrencyAmount, TradeType } from 'depin-dex-sdk-core'
import { encodeRouteToPath, MethodParameters, toHex } from './utils'
import IQuoter from 'depin-dex-v3-periphery/artifacts/contracts/lens/Quoter.sol/Quoter.json'
import IQuoterV2 from 'depin-dex-swap-router-contracts/artifacts/contracts/lens/QuoterV2.sol/QuoterV2.json'
