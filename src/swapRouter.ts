...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from 'depin-dex-sdk-core'
...
import ISwapRouter from 'depin-dex-v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
